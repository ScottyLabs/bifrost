  ...
  return (
    <div className="text-beige flex justify-center">
      <a href={registerLink} target="_blank" rel="noopener noreferrer">
        <div className="border-2 border-black py-3 px-6 text-2xl font-thin bg-blue animate-[float_2s_ease-in-out_infinite] text-white rounded-xl cursor-pointer hover:bg-black hover:text-red hover:border-red">
          Pre-register Now!
        </div>
      </a>
    </div>
